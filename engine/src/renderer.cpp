...
void renderer::draw_frame()
{
    ...
    vk_assert(vkAcquireNextImageKHR(_device.get(), _swapchain.get(), timeout, submit_semaphore, nullptr, &_image_index), "Failed to acquirean image.");
    ...
    VkSubmitInfo submit_info{.sType = VK_STRUCTURE_TYPE_SUBMIT_INFO,
                             ...
                             .pCommandBuffers = &_frame_cmdbuffers[_image_index],
...
void renderer::set_draw_commands()
{
    for (std::size_t i{}; i < _frame_cmdbuffers.size(); ++i)
    {
        ...
        }
        {
            ...
            VkClearValue clear_value{.color = VkClearColorValue{0, 0, 1, 1}};
        ...
        // vkCmdBindPipeline(_frame_cmdbuffers[i], VkPipelineBindPoint::VK_PIPELINE_BIND_POINT_GRAPHICS, _pipeline.get());
        vkCmdEndRenderPass(frame_cmdbuffer);
        vkEndCommandBuffer(frame_cmdbuffer);
    }
}
